...
class FormatForSearch:
    ...
    def begin_refining(self):
        ...
        to_open_filename = "./data/combineddata" + self.date + ".json"
...
# new_data_format = FormatForSearch()
